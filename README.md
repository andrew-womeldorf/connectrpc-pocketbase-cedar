...
The goal is to learn Cedar's policy language and toolchain while exploring what it looks like to embed PocketBase and a ConnectRPC API in the same Go binary.
